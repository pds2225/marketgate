"""
Regression test for require_plan / subscription store desync.

require_plan() must use subscription_store.get_subscription() as the
authoritative plan source. users.json plan stays Basic for many accounts.
"""
